    ...
    try {
      ...
      await auth.api.signUpEmail({
        body: {
          ...
          statusAktif: userRecord.statusAktif,
        } as any,
        asResponse: false
      });
      ...
      // ROLLBACK: Restore the user record if anything fails
      await db.insert(users).values(userRecord).onConflictDoNothing();
